...
#include "pyQt/PythonQtUtils.h"
#include "pyQt/PythonQtSystem.h"
#include "pyQt/PythonQtInstanceWrapper.h"
#include "pyQt/PythonQtClassWrapper.h"
#include "pyQt/PythonQtSlot.h"
#include "pyQt/PythonQtObjectPtr.h"
#include "pyQt/PythonQtStdIn.h"
#include <QObject>
#include <QVariant>
#include <QList>
#include <QHash>
...
public:
  ...
  explicit PythonQt(int flags, const QByteArray& pythonQtModuleName);
  ~PythonQt();
